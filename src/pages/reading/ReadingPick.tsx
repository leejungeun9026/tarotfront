...
import { getCardImg, getCategoryImg } from "@/utils/imageMapper";
...
function ReadingPick({ category, question }: Props) {
  ...
  const [readingSubmit, setReadingSubmit] = useState<boolean>(false);
          ...
          <PageTitle
            ...
            subtitle={
              <>
                ...
                <p>질문을 마음속으로 생각하며 신중하게 카드를 골라주세요</p>
              </>
            }
          />
        )}
