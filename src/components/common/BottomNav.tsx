...
function BottomNav() {
  return (
    <div className="BottomNav">
      <ul className="flex justify-center sm:justify-around items-center gap-2 border-t py-2 px-3" style={bottomNavHeight}>
        ...
        <NavItem title={"마이페이지"} icon={"account_circle"} link={"/mypage"} />
      </ul>
    </div>
  );
}
