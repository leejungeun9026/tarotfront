  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          "flex items-center gap-1 w-full absolute top-0 inset-x-0 justify-between h-12",
          defaultClassNames.nav
        ),
        button_previous: cn(
          buttonVariants({ variant: buttonVariant }),
          "size-12 aria-disabled:opacity-50 p-0 select-none",
        ...
        month_caption: cn(
          "flex items-center justify-center h-12 w-full px-10",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 dark:hover:text-accent-foreground flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] [&>span]:text-xs [&>span]:opacity-70 relative text-sm items-center justify-center rounded-full hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring",
        defaultClassNames.day,
        className
      )}
      {...props}
    >
      ...
      {modifiers.hasReading && (
        <span
          aria-hidden
          className={cn(
            "absolute left-1/2 -translate-x-1/2 bottom-1 sm:bottom-2 z-20 size-1 sm:size-2 rounded-full",
            modifiers.selected ? "bg-violet-50" : "bg-violet-500",
            "md:bottom-1.5 md:size-1.5"
          )}
        />
      )}
    </Button>
